...
fig, axarr = plt.subplots(3, 5, figsize=(30, 18))
	# mag_node_dict = {} # number of nodes
	# mag_edge_dict = {} # number of edges
	# mag_en_dict = {} # #edges/#nodes
	# mag_enp_dict = {} # #edges/(#nodes-#leaf)
...
t = 'rho=%s, p=%s'%(format(corr_list[0], '.2f'), format(p_list[0], '.2g'))
...
t = 'rho=%s, p=%s'%(format(corr_list[1], '.2f'), format(p_list[1], '.2g'))
...
t = 'rho=%s, p=%s'%(format(corr_list[2], '.2f'), format(p_list[2], '.2g'))
...
t = 'rho=%s, p=%s'%(format(corr_list[3], '.2f'), format(p_list[3], '.2g'))
...
axarr[0,4].scatter(y_human, y_countscc)
axarr[0,4].set_ylabel('#SCC',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[4], '.2f'), format(p_list[4], '.2g'))
axarr[0,4].set_title(t,y=0.85,fontsize=17)
axarr[0,4].yaxis.set_major_locator(MaxNLocator(nbins=6,integer=True))
axarr[0,4].tick_params(axis='both', labelsize=17)

axarr[1,0].scatter(y_human, y_maxscc)
axarr[1,0].set_ylabel('max SCC size',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[5], '.2f'), format(p_list[5], '.2g'))
axarr[1,0].set_title(t,y=0.85,fontsize=17)
axarr[1,0].yaxis.set_major_locator(MaxNLocator(nbins=6,integer=True))
axarr[1,0].tick_params(axis='both', labelsize=17)

axarr[1,1].scatter(y_human, y_countcycle)
axarr[1,1].set_ylabel('#cycles', fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[6], '.2f'), format(p_list[6], '.2g'))
...
axarr[1,2].scatter(y_human, y_maxcycle)
axarr[1,2].set_ylabel('max cycle size',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[7], '.2f'), format(p_list[7], '.2g'))
...
axarr[1,3].scatter(y_human, y_c_incycle)
axarr[1,3].set_ylabel('#cycles in cycles',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[8], '.2f'), format(p_list[8], '.2g'))
...
axarr[1,4].scatter(y_human, y_nnc)
axarr[1,4].set_ylabel('#node in cycles',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[9], '.2f'), format(p_list[9], '.2g'))
axarr[1,4].set_title(t,y=0.85,fontsize=17)
axarr[1,4].yaxis.set_major_locator(MaxNLocator(nbins=6,integer=True))
axarr[1,4].tick_params(axis='both', labelsize=17)

axarr[2,0].scatter(y_human, y_pnc)
axarr[2,0].set_ylabel('proportion nodes in cycles',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[10], '.2f'), format(p_list[10], '.2g'))
axarr[2,0].set_title(t,y=0.85,fontsize=17)
axarr[2,0].yaxis.set_major_locator(MaxNLocator(nbins=6,integer=False))
axarr[2,0].tick_params(axis='both', labelsize=17)

axarr[2,1].scatter(y_human, y_depth)
axarr[2,1].set_ylabel('longest path len from red',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[11], '.2f'), format(p_list[11], '.2g'))
...
axarr[2,2].scatter(y_human, y_ndepth)
axarr[2,2].set_ylabel('#longest paths from red',fontsize=20, fontweight='bold')
t = 'rho=%s, p=%s'%(format(corr_list[12], '.2f'), format(p_list[12], '.2g'))
...
# plt.show()
# plt.savefig('/Users/chloe/Desktop/testscatter.png')
