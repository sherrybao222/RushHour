...
if __name__ == "__main__":
	# compact version of preprocessed positions, only contains children_boards and children_num_cars_each_level
	...
	for puzzle in all_puzzles:
		...
		for position in all_legal_positions: # for each legal position, 
			...
			b_dict = {'children_boards':[], 'children_num_cars_each_level':[]}
			...
			for child in children_boards:
				...
				mag = MAG(child)
				mag.construct()
				b_dict['children_num_cars_each_level'].append(mag.num_cars_each_level)
	...
	''' preprocessed positions full size, contains children_ids, children_boards, and children_num_cars_each_level
	datapath = '/Users/yichen/Documents/RushHour/exp_data/data_adopted/'
	outpath = '/Users/yichen/Desktop/preprocessed_positions_full/'
	all_puzzles = os.listdir(datapath)
	for puzzle in all_puzzles:
		if not puzzle.endswith('.json'):
			continue
