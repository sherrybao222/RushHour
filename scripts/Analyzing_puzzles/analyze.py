...
from astar import make_Astar, make_Astar_all, h_unblocked
...
def recs_to_paths(recs,ins):
    ...
    try:
        ...
        print('instance in recs_to_paths ', instance)
    except:
        print('exception in recs_to_paths')
        return [],[]
    i=0
...
def calc_real_dist(filename,index=-1):
    ...
    """
    json_dir = '/Users/chloe/Documents/RushHour/exp_data/json'
            ...
            for path,rs_path in zip(paths,rs_paths):
                ...
                for i in range(len(path)):
                    ...
                    with open(outf, write_flag) as f:
                        f.write(line)
                    with open(pathsf, 'a') as f2:
                        # print(type(the_paths))
                        f2.write(str(the_paths))
                        f2.write('\n')
