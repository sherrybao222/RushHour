...
out_file = '/Users/chloe/Desktop/nodes_to_error_15.png'
...
ax[0].legend(loc='upper center', bbox_to_anchor=(0.55,0.9), prop={'size': 16})
ax12.legend(loc='upper center', bbox_to_anchor=(0.55,0.81), prop={'size': 16})
...
ax[1].set_ylim(top=np.nanmax(error_node/count_node)+0.65)
ax[1].tick_params(axis='both', which='major', labelsize=10)
ax[1].set_ylabel('Probability Error', fontsize=14)

fig.text(0.5, 0.029, \
	'Node', \
	ha='center', fontsize=15)
plt.suptitle('Probability of Error; Histogram of MAG Size; '+'Length-'+str(optlen_consider-1), \
